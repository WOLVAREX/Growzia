...
export const api = {
  ...
  platforms: () => request<{platforms:string[];disabledPlatforms:string[]}>('/admin/settings/platforms'),
  setPlatforms: (disabledPlatforms:string[]) => request<any>('/admin/settings/platforms',{method:'POST',body:JSON.stringify({disabledPlatforms})}),
